...
import { useGetAboutsQuery } from "../../redux/features/settings/settingApi";

const AboutUs = () => {
  const navigate = useNavigate();
  const { data, isError, isLoading } = useGetAboutsQuery(undefined);
  const content = "This is abouts content";
  return (
